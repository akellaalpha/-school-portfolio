...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        Logger loggerInfo = LogManager.getLogger("infoStation");
        ...
        for(;;)
        {
            try {
                ...
                loggerInfo.info("Станция отпраавления: " + from);
                loggerInfo.info("Станция назначения: " + to);
            ...
            {
                Logger loggerFatal = LogManager.getLogger("fatalSystemError");
                loggerFatal.fatal("В ходе выполнения программы возникла ошибка: " + ex);
            }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            Logger loggerError = LogManager.getLogger("stationError");
